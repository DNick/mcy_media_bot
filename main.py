...
START_MESSAGE = (
    "Приветствую Вас, пользователь! Я призван служить команде MCY и её союзникам. Я буду делать всё что в моих силах, "
    "чтобы помочь Вам перевенуть мир онлайн-благовестия. Пока я умею только вставлять логотип на изображения, "
    "но надеюсь, что скоро я стану мощным орудием против холодного мира неведения и неверия.\nОтправьте мне "
    "изображение или файл с изображением, и я вставлю на неё логотип MCY тотчас."
