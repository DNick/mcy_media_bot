...
- Уведомление в группу разработчиков при необработанной ошибке.
...
| `ALERT_GROUP_ID` | ID группы/канала разработчиков для уведомлений об ошибках             |
...
2. В разделе **Environment variables** задайте `BOT_TOKEN`, `ALERT_GROUP_ID`
